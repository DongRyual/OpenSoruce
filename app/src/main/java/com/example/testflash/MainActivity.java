...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        player = MediaPlayer.create(MainActivity.this, R.raw.button_sound);
    ...
    private void flashLightOn() throws CameraAccessException {
        ...
        Toast.makeText(MainActivity.this, "FlashLight is ON 전등켜짐!", Toast.LENGTH_SHORT).show();
    }
    ...
    private void flashLightOff() throws CameraAccessException {
        ...
        Toast.makeText(MainActivity.this, "FlashLight is OFF 전등꺼짐!", Toast.LENGTH_SHORT).show();
    }
}